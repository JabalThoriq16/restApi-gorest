...
import axios from 'axios'
  export default {
    async asyncData({ $axios, route }) {
        const form = await $axios.$get('https://gorest.co.in//public/v2/users/'+route.params.edit)
        return { form }
    },    
    data() {
      return {
    ...
    methods: {
      onSubmit() {
        ...
        axios.patch('https://gorest.co.in//public/v2/users/'+this.form.id+'?access-token=0359472d637566d3ebfe75360ab86cf27a9fd1661e6a425d5d04ac8f8592f2d6', this.form)
